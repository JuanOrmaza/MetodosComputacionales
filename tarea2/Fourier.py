...
plt.suptitle("Transformadas de fourier y frecuencias", fontsize=20)
plt.subplot(2,2,1)
plt.title("cara 1")
...
plt.savefig('transformadasyfrecuencias.png')
...
plt.suptitle("filtros", fontsize=20)
plt.subplot(1,2,1)
plt.title("cara 1")
